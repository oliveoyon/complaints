    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul>
                ...
                <li class="has-submenu">
                    <a href="#"><i class="fas fa-exclamation-circle"></i> Complaints Management</a>
                    <ul class="submenu">
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin.complaint-categories.index') }}">
                                <i class="fas fa-list"></i> Complaint Categories
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.severity-levels.index') }}">
                                <i class="fas fa-thermometer-half"></i> Severity Levels
                            </a>
                        </li>
                        <li>
