...
use App\Http\Controllers\Admin\SeverityLevelController;
...
Route::prefix('admin')->name('admin.')->middleware(['auth'])->group(function () {
    ...
    Route::resource('complaint-categories', ComplaintCategoryController::class)->except(['show']);
    Route::resource('severity-levels', SeverityLevelController::class)->except(['show']);
